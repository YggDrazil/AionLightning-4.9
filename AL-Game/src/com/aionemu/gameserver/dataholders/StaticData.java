...
public class StaticData {
    ...
    private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
        ...
        DataManager.log.info("Loaded " + conquestPortalData.size() + " conquest portal entries");
        ...
        DataManager.log.info("Loaded " + serialGuardData.size() + " serial guard entires");
		...
		DataManager.log.info("Loaded " + hiddenStigmas.size() + " hidden stigmas entries");
		DataManager.log.info("Loaded " + buffData.size() + " world buff map entries");
		//DataManager.log.info("Loaded " + playerAppearance.size() + " Player Appearances");
    }
}
