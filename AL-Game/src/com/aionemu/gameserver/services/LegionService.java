...
/*		
		log.info("Sending LegionSearch Size is :"+matchingLegions.size()+" Legions :");
		for (Legion legion : matchingLegions)
		{
			log.info("* LegionName : "+legion.getLegionName()+"(id:"+legion.getLegionId()+") BrigadeGeneral: "+getBrigadeGeneralName(legion)+ " Description: "+legion.getLegionDiscription()+" joinType: "+legion.getLegionJoinType()+" Min.Lv: "+legion.getMinLevel());
		}
*/		
	...
	public void handleJoinRequestGetAnswer(Player player)
	{
		...
		switch (pcd.getJoinRequestState())
    	{
    		case ACCEPTED:
    			...
    			else PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_LEGION_JOIN_SERVER_CHANGE);
    			break;
