...
public class CompositionAction extends AbstractItemAction {
    ...
    public void act(final Player player, final Item tools, final Item first, final Item second) {
        ...
        PacketSendUtility.sendPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(), tools.getObjectId(), tools.getItemTemplate().getTemplateId(), CompositionConfig.COMPOSITION_SPEED, 0, 0));
