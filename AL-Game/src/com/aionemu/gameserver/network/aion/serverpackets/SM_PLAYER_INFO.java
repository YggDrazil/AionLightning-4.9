    ...
    protected void writeImpl(AionConnection con) {
        ...
        for (Item item : items) {
        	...
        	if ((item.getAuthorize() > 0) && (item.getItemTemplate().isAccessory())) {
          		...
          		writeD(item.getEnchantLevel() >= 20 ? 4 : item.getEnchantLevel() == 15 ? 2 : 0);
        	} else {
          		writeD(0);
           	}
        }
        ...
        /**
         * === Conqueror ===
         * 0x01 = Conquerers Will Lvl 1 (Buff you get for killing enemies from their home map)
         * 0x02 = Furious Conquerers Will Lvl 2 (Buff you get for killing enemies from their home map)
         * 0x03 = Berserk Conquerers Will Lvl 3 (Buff you get for killing enemies from their home map)
         *
         * === Protector ==
         * 0x01 = Protector Lvl 1
         * 0x02 = Protector Lvl 2
         * 0x03 = Protector Lvl 3
         */
        writeC(player.getConquerorBuffId());
        writeC(player.getProtectorBuffId());        
        writeC(0x00); // 4.8
    }
}
