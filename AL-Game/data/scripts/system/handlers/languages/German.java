...
public class German extends Language {
	...
	public German() {
		...
		* Go Command (PvP Command)
        ...
        addTranslatedMessage(CustomMessageId.DECOMPOSE_SERVICE_MESSAGE2, "%s hat zusätzlich erhalten %s von %s (Premium).");
        addTranslatedMessage(CustomMessageId.DECOMPOSE_SERVICE_MESSAGE3, "%s hat zusätzlich erhalten %s von %s (VIP).");
