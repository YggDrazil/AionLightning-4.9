		...
		pTimer = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
					...
					public void run() {
						...
						if (getNpcs(855460).isEmpty() && getNpcs(855461).isEmpty() && getNpcs(855462).isEmpty() && getNpcs(855463).isEmpty() && getNpcs(855464).isEmpty() && getNpcs(855465).isEmpty()) {
							if (beritra.getEffectController().isAbnormalPresentBySkillId(21610) 
								|| beritra.getEffectController().isAbnormalPresentBySkillId(21611) 
								|| beritra.getEffectController().isAbnormalPresentBySkillId(21612)
								|| beritraHum.getEffectController().isAbnormalPresentBySkillId(21612)
								|| beritraHum.getEffectController().isAbnormalPresentBySkillId(21612)
								|| beritraHum.getEffectController().isAbnormalPresentBySkillId(21612)
								|| dragon.getEffectController().isAbnormalPresentBySkillId(21610) 
								|| dragon.getEffectController().isAbnormalPresentBySkillId(21611) 
								|| dragon.getEffectController().isAbnormalPresentBySkillId(21612)
								|| dragon.getEffectController().isAbnormalPresentBySkillId(21618)) {
								switch (Rnd.get(1, 6)) {
									case 1:
										sendMsg(1402728);
		...
		bChecker = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
						...
						public void run() {
							if (score == 0) {
								...
								if (!bBuff.getEffectController().isAbnormalPresentBySkillId(21610) 
									&& !bBuff.getEffectController().isAbnormalPresentBySkillId(21611) && !bBuff.getEffectController().isAbnormalPresentBySkillId(21612) && bBuff.getLifeStats().getHpPercentage() != 0) {
									despawnNpc(bBuff);
									beritraTrue();
