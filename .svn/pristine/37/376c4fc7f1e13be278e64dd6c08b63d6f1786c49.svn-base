	...
	protected void runImpl() {
		...
		switch (action) {
            ...
            case 1: // Cube Expansion Coin
            	if (activePlayer.getNpcExpands() < 11) { // if less than 10 rows open / 117 slots
    			...
    			} else if (activePlayer.getNpcExpands() == 11) { // 11 rows open
    			...
    			} else if (activePlayer.getNpcExpands() == 12) { // 12 rows open
    			...
    			} else if (activePlayer.getNpcExpands() == 13) { // 13 rows open
    			...
    			} else if (activePlayer.getNpcExpands() == 14) { // 14 rows open
