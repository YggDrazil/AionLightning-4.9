...
public class GoTo extends AdminCommand {
    ...
    public void execute(Player player, String... params) {
        ...
        } else if (destination.equalsIgnoreCase("idianelyos") || destination.equalsIgnoreCase("Idian Dephts")) { 
            goTo(player, 210090000, 671.0f, 646.0f, 514.8738f);
        } else if (destination.equalsIgnoreCase("idianasmos") || destination.equalsIgnoreCase("Idian Dephts")) { 
