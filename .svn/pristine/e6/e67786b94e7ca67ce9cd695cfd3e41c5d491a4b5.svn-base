...
public class Appearance extends AdminCommand {
    ...
    public void execute(Player admin, String... params) {
        ...
        {        	
        	...
        	else PacketSendUtility.sendMessage(player, "Something went wrong on saving Appearance Data");
        ...
        else if (params[0].equals("get"))
        {
        	...
        	playerAppearance.setLegThicnkess(app.legThickness);
