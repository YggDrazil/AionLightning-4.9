...
public class Conquest_PortalAI2 extends ActionItemNpcAI2 {
	...
	protected void handleUseItemFinish(Player player) {
		...
		if (player.getAccessLevel() >= 2) PacketSendUtility.sendMessage(player, "ConquestPortal AI wurde geladen");
		...
		if (player.getAccessLevel() >= 2) PacketSendUtility.sendMessage(player, "ConquestPortal [DEBUG] - Teleporting to : "+loc.toString());
