...
//    private boolean wave4_done = false; //of level2 TODO
    ...
    public void spawnRings(){ // Ring for wave at level2
        FlyRing waveStarter = new FlyRing(new FlyRingTemplate("waves_level2", mapId,
                new Point3D(566.06354f, 245.26855f, 928.0467f),
                new Point3D(568.7914f, 246.79665f, 928.0467f),
                new Point3D(564.0763, 242.45244f, 928.0466f), 5), instanceId);
